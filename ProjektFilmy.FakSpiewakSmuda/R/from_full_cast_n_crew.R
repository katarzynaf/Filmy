#' Pobieranie tabel z podstrony obsady portalu IMDb.
#'
#' Funkcja \code{from_full_cast_n_crew} zwraca jednowierszowa ramke danych z informacja o rezyserze,
#' obsadzie oraz autorach scenariusza, muzyki i zdjec. Ewentualnych kilka nazwisk (jak np. przy obsadzie)
#' rozdzielanych jest separatorem \code{sep}.
#'
#' @aliases from_full_cast_n_crew
...
#' @return jednowierszowa ramka danych o nazwach kolumn: "DirectedBy"|"Cast"|"Writing"|"ProducedBy"|"MusicBy"|"CinematographyBy"
#' @import rvest
#' @import dplyr
#' @import stringi
#' @export
...
from_full_cast_n_crew <- function( link,sep="," ){
      ...
      rm(tytuly_kolumn,info_z_cast_crew,headers,tables,link)
}
